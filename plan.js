...
const PLAN = {
  ...
  plans: {
    seoul: {
      ...
      evaStatus:"保留未用",
      icelandPath:"ICN → CPH → KEF",
      tpeIcn: { price:33632, stops:1, duration:"25小時45分鐘" },
      icnCph: { carrier:"大韓航空 KE 直飛", duration:"約 10h 45m" },
      cphKef: { carrier:"SAS 斯堪地那維亞航空", duration:"約 3h" },
      milesNote:"以上兩段來回共用 22,000 阿聯酋哩 + NT$1,013（來回）",
      returnRoute:"KEF → CPH → ICN → TPE",
      returnNote:"回程含在 22,000 哩內・ICN→TPE 另購",
  ...
  compareRows: [
    ...
    { label:"阿聯酋哩程",
      seoul: { text:"22,000 哩 + NT$1,013 ✅", sub:"來回・剩 6,600 哩", color:"emerald" },
      london:{ text:"23,446（剩 5,154）✅", color:"blue" } },
    { label:"長榮 49,812 哩",
      seoul: { text:"保留（未用）", color:"gray" },
      london:{ text:"升艙全用上 ✅", color:"emerald" } },
    { label:"長途飛行艙位",
      seoul: { text:"經濟艙（ICN→CPH 11h）", color:"gray" },
      london:{ text:"豪華經濟 / 商務艙 ✅", color:"blue" } },
    { label:"首爾→冰島飛行",
      seoul: { text:"ICN→CPH→KEF", sub:"約 14 小時", color:"gray" },
      london:{ text:"LHR→LGW→KEF", sub:"約 4–5 小時 ✅", color:"blue" } },
    { label:"中途城市",
